...
const FALLBACK_PAGES: Record<ContentPageKey, ContentPage> = {
  ...
  contact: {
    ...
    content: {
      ...
      body: 'Visit our office in Namakkal or contact our sales team to view available plots.',
    },
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  privacy: {
    ...
    content: {
      ...
      body: 'Your Choice Properties respects your privacy and protects your personal data.',
    },
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
  terms: {
    ...
    content: {
      ...
      body: 'Terms and conditions governing the use of Your Choice Properties services and website.',
    },
    created_at: new Date().toISOString(),
    updated_at: new Date().toISOString(),
  },
